...
const Navigation = () => {
  ...
  <a className="navbar-brand js-scroll-trigger" href="#page-top">
    ...
    <span className="d-none d-lg-block"><img className="img-fluid img-profile rounded-circle mx-auto mb-2" src="https://github.com/amandamamesah/manda-cv/blob/master/src/assets/img/profile.jpg?raw=true" alt="..." /></span>
  </a>
